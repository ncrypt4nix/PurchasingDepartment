#ifndef PAYMENTDOCUMENTSHANDBOOK_H
#define PAYMENTDOCUMENTSHANDBOOK_H
...
namespace logics
{
    /*! \brief Класс-Справочник для Платежных документов */
    class PaymentDocumentsHandBook : public HandBookAbstract
    {
        Q_OBJECT
    public:
        /*!
         ...
         */
        explicit PaymentDocumentsHandBook(QObject *parent = 0);
...
#endif // PAYMENTDOCUMENTSHANDBOOK_H
